...
MissavSubtitleFinder字幕搜索脚本（油猴/Tampermonkey）。主要提供：[Missav](https://missav.ws/dm194/cn)自动嗅探m3u8视频链接、在线字幕（sub-dog）、多清晰度播放等能力。
...
- 在视频播放页，有时需要先点击视频播放，才能检测到M3U8链接，若弹出广告页，请关闭关闭广告页，回到视频播放页
